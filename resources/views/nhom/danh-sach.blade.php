			      ...
			      <div class="modal-content">
			        ...
			        <div class="modal-footer">
                                      ...
                                      <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input id="ma_edit" class="form-control col-md-12 col-xs-12" name="ma" placeholder="Enter ma" required="required" type="text">
                                    ...
                                    <div class="form-group">
                                      ...
                                      <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input id="ten_edit" class="form-control col-md-12 col-xs-12" name="ten" placeholder="Enter ten" required="required" type="text">
                                    ...
                                    <div class="form-group">
                                      <label class="control-label col-md-3 col-sm-3 col-xs-12" for="ten">Chức năng <span class="required"></span></label>
                                      <div class="col-md-6 col-sm-6 col-xs-12">
                                        <table class="table table-bordered">
                                              ...
                                              <tbody class="view-per">
                                                @foreach($idChucNang as $key => $value)
                                                  <tr>
                                                    <td><input type="checkbox" value={{$key}} name="chucnangids[]" class="chucnangids"/></td>
                                                    <td>{{$value}}</td>
                                                  </tr>
                                                @endforeach
                                              </tbody>
