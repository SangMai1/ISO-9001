declare const Swal: SwalInterface
interface SwalInterface {
   ...
   * ```
   */
  fire<T = any>(title?: string, html?: string, icon?: SweetAlertIcon): Promise<SweetAlertResult<Awaited<T>>>;
   ...
   * ```
   */
  update(options: Pick<SweetAlertOptions, SweetAlertUpdatableParameters>): void;
   ...
   * ```
   */
  showLoading(buttonToReplace?: HTMLButtonElement): void;
   ...
   */
  queue<T>(steps: readonly (SweetAlertOptions | string)[]): Promise<T>;
   ...
   */
  isValidParameter(paramName: string): paramName is keyof SweetAlertOptions;
   ...
   * @param paramName The parameter to check
   */
  isUpdatableParameter(paramName: string): paramName is SweetAlertUpdatableParameters;
   ...
   */
  argsToParams<T>(params: SweetAlertArrayOptions | readonly [SweetAlertOptions<T>]): SweetAlertOptions<T>;
}
...
declare interface SweetAlertOptions<PreConfirmResult = any, PreConfirmCallbackValue = any> {
   ...
   * You can also pass a custom  returning a boolean value, e.g. if you want
   ...
   * You can also pass a custom  returning a boolean value.
   *
   * @default true
   */
